...
class VAERunClient(ModelRunClient):
    ...
    def _training(self, batch_size: int, epoch: int, weights_file_name: str, model_file_name: str) -> None:
        """
        訓練を実行
        ...
        try:
            ...
            print("\nユーザーによる割り込みがありました")
            self._save_with_checking(weights_file_name, model_file_name)
